...
Special thanks to the creators of the `jwsacruncher` Java package, which plays an integral role in the functionality of `eseas`.  
...
For more details, visit the [`jwsacruncher` GitHub repository](https://github.com/jdemetra/jwsacruncher).
